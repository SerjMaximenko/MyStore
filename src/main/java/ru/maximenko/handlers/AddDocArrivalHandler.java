...
public class AddDocArrivalHandler extends MainHandler implements HttpHandler {
            ...
            switch (requestMethod) {
                case METHOD_POST:
                    ...
                    try {
                        ...
                        responseBody = docService.addDocArrival(new Gson().fromJson(jsonObject.toString(), DocInputDto.class));
