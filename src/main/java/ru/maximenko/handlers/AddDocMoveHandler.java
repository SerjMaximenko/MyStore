...
public class AddDocMoveHandler extends MainHandler implements HttpHandler {
            ...
            switch (requestMethod) {
                case METHOD_POST:
                    ...
                    try {
                        ...
                        responseBody = docService.addDocMove(new Gson().fromJson(jsonObject.toString(), DocMoveDto.class));
