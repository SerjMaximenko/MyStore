...
@Entity
@Table (name = "documents_sale_head")
public class DocSaleHead {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long id;

    @OneToMany(fetch = FetchType.EAGER, mappedBy = "docSaleHead")
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof DocSaleHead)) return false;
        final DocSaleHead other = (DocSaleHead) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof DocSaleHead;
    }
    ...
    public String toString() {
        return "DocSaleHead(id=" + this.getId() + ", item=" + this.getItem() + ", storage=" + this.getStorage() + ")";
    }
}
